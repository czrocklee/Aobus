...
namespace rs::tag::detail
{
  std::string_view stashOwnedString(rs::tag::File const& owner, std::string value);
}
...
namespace rs::tag
{
  ...
  class File
  {
    friend std::string_view detail::stashOwnedString(rs::tag::File const& owner, std::string value);
  ...
  namespace detail
  {
    inline std::string_view stashOwnedString(rs::tag::File const& owner, std::string value)
    {
