---
name: cppgen
description: Generate C++ code following C++23 best practices for RockStudio. Use when writing, generating, or modifying any C++ code in include/, src/, app/, tool/, or test/ directories.
---
