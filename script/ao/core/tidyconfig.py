...
{Checks: 'PLACEHOLDER',
 CheckOptions: [
  ...
  {key: 'misc-include-cleaner.IgnoreHeaders', value: '.*yaml-cpp.*;.*ryml.*;.*c4/.*;.*boost/asio/.*;.*boost/interprocess/.*;.*boost/system/.*;.*boost/unordered/.*;.*boost/pfr.*;.*/flat_(set|map);.*/errno.h;.*glib.*'}
 ]}"""
