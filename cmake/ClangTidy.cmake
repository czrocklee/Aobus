...
if(CLANG_TIDY_EXECUTABLE)
  ...
  set(_AO_CLANG_TIDY_RELAXED_FILTER "'${CMAKE_SOURCE_DIR}/test/.*'")
...
function(aobus_apply_clang_tidy target mode)
  ...
  elseif(mode STREQUAL "RELAXED")
    set_target_properties(${target} PROPERTIES
      CXX_CLANG_TIDY "${CLANG_TIDY_EXECUTABLE};${_AO_CLANG_TIDY_RELAXED_CHECKS};-header-filter=${_AO_CLANG_TIDY_RELAXED_FILTER};${_AO_CLANG_TIDY_EXTRA_ARGS}"
    )
  else()
