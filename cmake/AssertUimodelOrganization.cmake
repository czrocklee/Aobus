...
set(_ao_uimodel_allowed_path_regex
    "^(FrameClock\\.h|field/[^/]+\\.(h|hpp|cpp)|input/[^/]+\\.(h|hpp|cpp)|layout/(document|action|component|shell)/[^/]+\\.(h|hpp|cpp)|library/(list|presentation|track|detail|property)/[^/]+\\.(h|hpp|cpp)|playback/(now-playing|transport|seek|output|queue|quality|soul)/[^/]+\\.(h|hpp|cpp)|status/activity/[^/]+\\.(h|hpp|cpp))$")
