...
set(_ao_uimodel_allowed_path_regex
    "^(FrameClock\\.h|field/[^/]+\\.(h|hpp|cpp)|input/[^/]+\\.(h|hpp|cpp)|preference/[^/]+\\.(h|hpp|cpp)|presentation/[^/]+\\.(h|hpp|cpp)|layout/(document|action|component|shell)/[^/]+\\.(h|hpp|cpp)|library/(list|presentation|track|detail|property|task)/[^/]+\\.(h|hpp|cpp)|playback/(command|now-playing|transport|seek|output|quality|soul)/[^/]+\\.(h|hpp|cpp)|status/activity/[^/]+\\.(h|hpp|cpp))$")
