...
| Interactive startup, checkpointing, switching, and shutdown | [Interactive session lifecycle](interactive-session-lifecycle.md) | Current | GTK and TUI intentionally retain separate lifecycle owners; RFC 0019 only proposes safer GTK replacement ordering. |
