...
- [`ShellLayoutStore`](../../app/linux-gtk/app/ShellLayoutStore.h), [`ShellLayoutComponentStateStore`](../../app/linux-gtk/app/ShellLayoutComponentStateStore.h), and [`GtkLayoutStateStore`](../../app/linux-gtk/app/GtkLayoutStateStore.h) are GTK file adapters; [`LayoutStateStore`](../../app/tui/LayoutStateStore.h) is the independent terminal presentation-file adapter.
...
- [`LibraryControllerTest.cpp`](../../test/unit/tui/LibraryControllerTest.cpp) protects exact TUI view attachment and per-list presentation resolution; [`LayoutStateStoreTest.cpp`](../../test/unit/tui/LayoutStateStoreTest.cpp) protects the independent per-library file, atomic two-group saves, sibling preservation, and load isolation.
...
- [`AppConfigStoreTest.cpp`](../../test/unit/linux-gtk/app/AppConfigStoreTest.cpp), [`KeymapStoreTest.cpp`](../../test/unit/uimodel/input/KeymapStoreTest.cpp), and [`KeymapTest.cpp`](../../test/unit/tui/KeymapTest.cpp) protect the GTK file boundary, shared override schema, and TUI default/projection boundary.
