...
| [0017](0017-exact-active-workspace-view.md) | None | None | None |
| [0018](0018-preserve-restored-view-presentation.md) | None | None | None |
...
- [RFC 0017: Exact active workspace view](0017-exact-active-workspace-view.md) restores focus by ordered view entry instead of base list id.
- [RFC 0018: Preserve restored view presentation](0018-preserve-restored-view-presentation.md) keeps exact workspace presentation state when GTK applies list defaults.
