...
This contract belongs to the **application runtime** layer in the [system architecture](../overview.md), under the [playback](README.md), [persistence](../persistence/README.md), and [interactive session lifecycle](../session-lifecycle.md) architectures.
