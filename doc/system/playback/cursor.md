...
Playback ownership and execution domains belong to the [playback architecture](README.md).
Ordered source membership belongs to [track sources](../library/track-source.md), projection delta production belongs to the [track-list projection](../library/track-list-projection.md), presentation ordering belongs to [track-list presentation](../presentation/track-presentation.md), and persisted payload and restore behavior belong to [playback session persistence](session-persistence.md).
The public application boundary coordinates commits without replacing the succession behavior owned here.

## Code boundary

This contract belongs to the **application runtime** layer in the [system architecture](../overview.md) and refines the succession authority in the [playback architecture](README.md).
...
The cursor consumes the sequential range coordinates, singleton reset, and terminal invalidation batches defined by the [track-list projection](../library/track-list-projection.md).
...
- [Track-list projection](../library/track-list-projection.md)
