...
This contract spans the **UIModel** and **GTK frontend** layers in the [system architecture](../overview.md), under the [application shell architecture](README.md).
...
The [GTK dialog-lifecycle specification](../frontend/gtk/dialog-lifecycle.md) owns the editor's visible close and error-message behavior.
...
- [Application shell architecture](README.md)
