...
The [system architecture](../overview.md) places reusable signal and subscription mechanisms in the core `ao_async` library.
The [runtime execution architecture](README.md) owns callback-executor affinity and requires each service to choose and enforce its serialized observation domain.
...
- [Runtime execution architecture](README.md)
