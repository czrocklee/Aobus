...
The [system architecture](../overview.md) places reusable filesystem mechanisms in Core libraries.
The [persistence and managed-state architecture](README.md) places atomic replacement below runtime, UIModel, frontend stores, schemas, and lifecycle owners.
