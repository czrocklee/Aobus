...
This contract belongs to the **application runtime** layer in the [system architecture](../overview.md) and refines the process-wide [runtime execution architecture](../execution/README.md).
