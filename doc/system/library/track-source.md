...
Projection behavior belongs to the [track-list](track-list-projection.md) and [track-detail](track-detail-projection.md) specifications.
Changeset production belongs to [library change publication](change-publication.md).
...
The cache is the library's [change-publication replica](change-publication.md).
...
- [Track-list projection](track-list-projection.md)
