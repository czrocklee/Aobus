...
Outcome selection belongs to the [outcome channel specification](outcome-channel.md), and ownership belongs to the [failure and reporting architecture](README.md).

## Code boundary

The [system architecture](../overview.md) places the facility in the Core utility layer.
