...
Observable channel selection and translation rules belong to the [outcome channel specification](outcome-channel.md).

## Code boundary

The [system architecture](../overview.md) places these types in the core-library layer, and the [failure and reporting architecture](README.md) defines how higher layers consume them.
