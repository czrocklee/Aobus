...
- [Persisted presentation state](presentation/persisted-state.md) enumerates versioned interactive-frontend presentation documents, stable token authorities, validation, and compatibility behavior.
