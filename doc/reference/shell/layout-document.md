...
Template expansion, build, editor, and fallback behavior belong to the [shell layout lifecycle specification](../../system/shell/layout-lifecycle.md).
...
This surface belongs to the **UIModel** layer in the [system architecture](../../system/overview.md), under the [application shell architecture](../../system/shell/README.md).
...
- Component type, property, child-count, surface, and action-binding validation uses the live schema from the [GTK schema reference](layout-schema.md).
...
- [`LayoutValidation.cpp`](../../../app/uimodel/layout/document/LayoutValidation.cpp) defines whole-candidate schema, surface, action, and common-field validation.
...
- [`LayoutValidationTest.cpp`](../../../test/unit/uimodel/layout/document/LayoutValidationTest.cpp) protects schema, surface, action, and common-field rejection.
