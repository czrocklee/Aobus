...
namespace
{
  ...
  bool isLosslessFormatChange(app::core::playback::StreamFormat const& src, app::core::playback::StreamFormat const& dst) noexcept
  {
...
namespace app::playback
{
  ...
  struct PipeWireBackend::RegistryMonitorState
 final
  {
