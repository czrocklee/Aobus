...
#define APP_LOG_INFO(...)                                                                                              \
  if (::app::core::Log::getAppLogger()->should_log(spdlog::level::info))                                               \
  ::app::core::Log::getAppLogger()->info(__VA_ARGS__)
#define APP_LOG_WARN(...)                                                                                              \
  if (::app::core::Log::getAppLogger()->should_log(spdlog::level::warn))                                               \
  ::app::core::Log::getAppLogger()->warn(__VA_ARGS__)
#define APP_LOG_ERROR(...)                                                                                             \
  if (::app::core::Log::getAppLogger()->should_log(spdlog::level::err))                                                \
  ::app::core::Log::getAppLogger()->error(__VA_ARGS__)
