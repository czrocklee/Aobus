...
namespace ao::tui
{
  ...
  std::string chromeText(i18n::MessageCatalog const& catalog, i18n::MessageId id);
  std::string overlayHintText(i18n::MessageCatalog const& catalog, i18n::MessageId id, std::string_view toggleKey);
  std::string notificationFooter(i18n::MessageCatalog const& catalog, std::string_view toggleKey);
