...
namespace ao::uimodel
{
   ...
   * Retains the LayoutRuntimeState (not the transient per-build carrier) so writes
  ...
  {
  public:
    StatefulComponentState(LayoutRuntimeState& runtimeState,
