...
private:
  ...
  std::shared_ptr<app::gtkmm4::model::TrackRowDataProvider> _rowDataProvider;

  // All tracks TrackId list (owned)
  std::unique_ptr<app::gtkmm4::model::AllTrackIdsList> _allTrackIds;
  ...
  void createList(app::gtkmm4::model::ListDraft const& draft);
  void onDeleteList();
  void onTagTrack();
