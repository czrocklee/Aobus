...
namespace ao::uimodel
{
  ...
  PlaybackQueueSession::PlaybackQueueSession(rt::PlaybackService& playback, rt::NotificationService& notifications)
  ...
  bool PlaybackQueueSession::playQueue(std::vector<TrackId> trackIds, TrackId startTrackId, ListId sourceListId)
  {
    if (trackIds.empty())
    {
      return false;
  ...
  bool PlaybackQueueSession::restoreQueue(std::vector<TrackId> trackIds,
                                          rt::PlaybackSessionState const& session,
  ...
  bool PlaybackQueueSession::hasNext() const
  {
    if (!_queueStatePtr)
    {
      return false;
  ...
  bool PlaybackQueueSession::hasPrevious() const
  {
    if (!_queueStatePtr)
    {
      return false;
  ...
  std::optional<TrackId> PlaybackQueueSession::peekNext()
  {
  ...
  void PlaybackQueueSession::next()
  {
    if (!_queueStatePtr)
    {
      return;
  ...
  void PlaybackQueueSession::previous()
  {
    if (!_queueStatePtr)
    {
      return;
  ...
  void PlaybackQueueSession::resume()
  {
    _playback.resume();
  }

  bool PlaybackQueueSession::isActive() const
  {
    return _queueStatePtr != nullptr;
  }

  std::optional<TrackId> PlaybackQueueSession::nowPlayingTrackId() const
  {
  ...
  ListId PlaybackQueueSession::sourceListId() const
  {
    if (!_queueStatePtr)
    {
  ...
  void PlaybackQueueSession::clear()
  {
  ...
  std::optional<std::size_t> PlaybackQueueSession::peekNextIndex()
  {
  ...
  Result<> PlaybackQueueSession::playIndex(std::size_t index)
  {
  ...
  bool PlaybackQueueSession::tryAdvanceToIndex(std::size_t index)
  {
  ...
  void PlaybackQueueSession::prepareNext()
  {
    if (!_queueStatePtr)
    {
      _playback.clearPreparedNext();
  ...
  void PlaybackQueueSession::commitNowPlaying(TrackId trackId, ListId sourceListId)
  {
  ...
  void PlaybackQueueSession::advanceToNext()
  {
    if (!_queueStatePtr)
    {
      return;
  ...
  void PlaybackQueueSession::handlePlaybackFailure(rt::PlaybackFailure const& failure)
  {
    if (!_queueStatePtr)
    {
      return;
  ...
  void PlaybackQueueSession::subscribeEvents()
  {
  ...
  void PlaybackQueueSession::unsubscribeEvents()
  {
    _idleSub.reset();
