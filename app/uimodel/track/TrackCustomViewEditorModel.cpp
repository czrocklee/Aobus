...
namespace ao::uimodel::track
{
  ...
  TrackCustomViewEditorModel::TrackCustomViewEditorModel()
  ...
  TrackCustomViewEditorModel::TrackCustomViewEditorModel(rt::TrackPresentationSpec const& spec, std::string_view label)
    : TrackCustomViewEditorModel{}
  {
    populate(spec, label);
  }

  void TrackCustomViewEditorModel::populate(rt::TrackPresentationSpec const& spec, std::string_view label)
  {
  ...
  void TrackCustomViewEditorModel::setLabel(std::string_view label)
  {
    _label = std::string{label};
  }

  void TrackCustomViewEditorModel::setGroupKey(rt::TrackGroupKey key)
  {
    _groupKey = key;
  }

  bool TrackCustomViewEditorModel::setGroupKeyByOptionIndex(std::size_t optionIndex)
  {
  ...
  std::optional<std::size_t> TrackCustomViewEditorModel::groupKeyOptionIndex() const
  {
  ...
  void TrackCustomViewEditorModel::addSortTerm()
  {
    _sortTerms.push_back({rt::TrackSortField::Title, true});
  }

  bool TrackCustomViewEditorModel::removeSortTerm(std::size_t index)
  {
  ...
  bool TrackCustomViewEditorModel::moveSortTermUp(std::size_t index)
  {
  ...
  bool TrackCustomViewEditorModel::moveSortTermDown(std::size_t index)
  {
  ...
  bool TrackCustomViewEditorModel::setSortFieldByOptionIndex(std::size_t termIndex, std::size_t optionIndex)
  {
  ...
  bool TrackCustomViewEditorModel::setSortAscending(std::size_t termIndex, bool ascending)
  {
  ...
  std::optional<std::size_t> TrackCustomViewEditorModel::optionIndexForSortField(rt::TrackSortField field) const
  {
  ...
  void TrackCustomViewEditorModel::addVisibleField()
  {
    _visibleFields.push_back(rt::TrackField::Title);
  }

  bool TrackCustomViewEditorModel::removeVisibleField(std::size_t index)
  {
  ...
  bool TrackCustomViewEditorModel::moveVisibleFieldUp(std::size_t index)
  {
  ...
  bool TrackCustomViewEditorModel::moveVisibleFieldDown(std::size_t index)
  {
  ...
  bool TrackCustomViewEditorModel::setVisibleFieldByOptionIndex(std::size_t fieldIndex, std::size_t optionIndex)
  {
  ...
  std::optional<std::size_t> TrackCustomViewEditorModel::optionIndexForVisibleField(rt::TrackField field) const
  {
  ...
  rt::CustomTrackPresentationPreset TrackCustomViewEditorModel::collectState(std::string_view generatedId) const
  {
  ...
  std::vector<TrackGroupKeyOption> TrackCustomViewEditorModel::createGroupOptions()
  {
  ...
  std::vector<TrackSortFieldOption> TrackCustomViewEditorModel::createSortFieldOptions()
  {
  ...
  std::vector<TrackVisibleFieldOption> TrackCustomViewEditorModel::createVisibleFieldOptions()
  {
