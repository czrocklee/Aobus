...
{
  /**
   * @brief A composite widget providing a Stop button.
   */
  class StopButton final
  {
  public:
    StopButton(ao::rt::PlaybackService& playbackService, bool showLabel = false, std::string const& size = "normal");
