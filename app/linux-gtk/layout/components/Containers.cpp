...
namespace ao::gtk::layout
{
  ...
  namespace
  {
    ...
    {
    public:
      BoxComponent(ComponentContext& ctx, LayoutNode const& node)
      {
    ...
    {
    public:
      SplitComponent(ComponentContext& ctx, LayoutNode const& node)
      {
    ...
    {
    public:
      ScrollComponent(ComponentContext& ctx, LayoutNode const& node)
      {
    ...
    {
    public:
      SpacerComponent(ComponentContext& /*ctx*/, LayoutNode const& /*node*/) {}
    ...
    {
    public:
      TabsComponent(ComponentContext& ctx, LayoutNode const& node)
    ...
    std::unique_ptr<ILayoutComponent> createBox(ComponentContext& ctx, LayoutNode const& node)
    {
      return std::make_unique<BoxComponent>(ctx, node);
    }

    std::unique_ptr<ILayoutComponent> createSplit(ComponentContext& ctx, LayoutNode const& node)
    {
      return std::make_unique<SplitComponent>(ctx, node);
    }

    std::unique_ptr<ILayoutComponent> createScroll(ComponentContext& ctx, LayoutNode const& node)
    {
      return std::make_unique<ScrollComponent>(ctx, node);
    }

    std::unique_ptr<ILayoutComponent> createSpacer(ComponentContext& ctx, LayoutNode const& node)
    {
      return std::make_unique<SpacerComponent>(ctx, node);
    }

    std::unique_ptr<ILayoutComponent> createTabs(ComponentContext& ctx, LayoutNode const& node)
    {
    ...
    {
    public:
      AbsoluteCanvasComponent(ComponentContext& ctx, LayoutNode const& node)
    ...
    std::unique_ptr<ILayoutComponent> createAbsoluteCanvas(ComponentContext& ctx, LayoutNode const& node)
    {
  ...
  void registerContainerComponents(ComponentRegistry& registry)
  {
    registry.registerComponent({.type = "absoluteCanvas",
                                ...
                                .category = "Containers",
                                .container = true,
                                .props = {{"snapToGrid", PropertyKind::Bool, "Snap To Grid", LayoutValue{true}, {}},
                                          {"gridSize", PropertyKind::Int, "Grid Size", LayoutValue{8}, {}}},
                                .layoutProps = {},
                                .minChildren = 0,
    ...
    registry.registerComponent(
      {.type = "box",
       ...
       .container = true,
       .props =
         {{"orientation", PropertyKind::Enum, "Orientation", LayoutValue{"vertical"}, {"vertical", "horizontal"}},
          {"spacing", PropertyKind::Int, "Spacing", LayoutValue{0}, {}},
          {"homogeneous", PropertyKind::Bool, "Homogeneous", LayoutValue{false}, {}}},
       .layoutProps = {},
       .minChildren = 0,
       .maxChildren = std::nullopt},
      createBox);
    ...
    registry.registerComponent(
      {.type = "split",
       ...
       .props =
         {{"orientation", PropertyKind::Enum, "Orientation", LayoutValue{"vertical"}, {"vertical", "horizontal"}},
          {"position", PropertyKind::Int, "Position", LayoutValue{-1}, {}},
          {"resizeStart", PropertyKind::Bool, "Resize Start", LayoutValue{true}, {}},
          {"shrinkStart", PropertyKind::Bool, "Shrink Start", LayoutValue{false}, {}},
          {"resizeEnd", PropertyKind::Bool, "Resize End", LayoutValue{true}, {}},
          {"shrinkEnd", PropertyKind::Bool, "Shrink End", LayoutValue{false}, {}}},
       .layoutProps = {},
       .minChildren = 2,
       .maxChildren = 2},
      createSplit);
      ...
      {.type = "scroll",
       ...
       .props = {{"hscrollPolicy",
                 ...
                 {"vscrollPolicy",
                  ...
                  LayoutValue{"automatic"},
                  {"automatic", "always", "never"}},
                 {"minContentWidth", PropertyKind::Int, "Min Content Width", LayoutValue{-1}, {}},
                 {"minContentHeight", PropertyKind::Int, "Min Content Height", LayoutValue{-1}, {}},
                 {"propagateNaturalWidth", PropertyKind::Bool, "Propagate Nat. Width", LayoutValue{false}, {}},
                 {"propagateNaturalHeight", PropertyKind::Bool, "Propagate Nat. Height", LayoutValue{false}, {}}},
       .layoutProps = {},
       .minChildren = 1,
       .maxChildren = 1},
      createScroll);
    ...
    registry.registerComponent({.type = "tabs",
                                .displayName = "Tabs",
                                .category = "Containers",
                                .container = true,
                                .props = {},
                                .layoutProps = {{"title", PropertyKind::String, "Tab Title", LayoutValue{""}, {}},
                                                {"icon", PropertyKind::String, "Tab Icon", LayoutValue{""}, {}}},
                                .minChildren = 1,
                                .maxChildren = std::nullopt},
                               createTabs);
  }
