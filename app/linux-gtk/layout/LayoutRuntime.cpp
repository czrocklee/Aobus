...
#include "components/PlaybackComponents.h"
#include "components/SemanticComponents.h"
...
namespace ao::gtk::layout
{
  ...
  std::unique_ptr<ILayoutComponent> LayoutRuntime::build(ComponentContext& ctx, LayoutDocument const& doc)
  {
