...
{
  TEST_CASE("ExecutionPlan - preserves field enum values", "[query][unit][execution-plan][contract]")
  {
    // String fields
  ...
  TEST_CASE("compileQuery returns Result without throwing", "[query][unit][execution-plan][contract]")
  {
