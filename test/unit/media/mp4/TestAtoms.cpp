...
namespace ao::test::mp4
{
  ...
  std::vector<std::uint8_t> makeSampleEntryAtom(std::string_view sampleEntryType, std::vector<std::uint8_t> const& body)
  {
  ...
  std::vector<std::uint8_t> makeMdhdAtom(std::uint32_t timescale, std::uint32_t duration)
  {
  ...
  std::vector<std::uint8_t> makeStszAtom(std::uint32_t sampleSize, std::uint32_t sampleCount)
  {
    auto body = std::vector<std::uint8_t>{};
    appendBe32(body, 0);
  ...
  std::vector<std::uint8_t> makeSttsAtom(std::uint32_t sampleCount, std::uint32_t sampleDelta)
  {
    auto body = std::vector<std::uint8_t>{};
    appendBe32(body, 0);
    appendBe32(body, 1);
  ...
  std::vector<std::uint8_t> makeStscAtom(std::uint32_t samplesPerChunk,
  ...
  std::vector<std::uint8_t> makeStcoAtom(std::uint32_t chunkOffset)
  {
    auto body = std::vector<std::uint8_t>{};
    appendBe32(body, 0);
    appendBe32(body, 1);
  ...
  std::vector<std::uint8_t> makeVideoTrackAtom(std::string_view sampleEntryType)
  {
