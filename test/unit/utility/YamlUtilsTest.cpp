...
namespace ao::test
{
  ...
  TEST_CASE("YAML utilities - scalar parsing is strict and non-throwing", "[core][unit][yaml]")
  {
  ...
  TEST_CASE("YAML utilities - recoverable helpers return Result", "[core][unit][yaml]")
  {
  ...
  TEST_CASE("YAML utilities - callback context owns diagnostic filename", "[core][unit][yaml]")
  {
