  ...
  namespace ao::gtk::test
{
  ...
  TEST_CASE("PlaybackPositionInterpolator - State handling", "[playback][unit][interpolator]")
  {
  ...
  TEST_CASE("PlaybackPositionInterpolator - Interpolation logic", "[playback][unit][interpolator]")
  {
    auto interpolator = PlaybackPositionInterpolator{};
