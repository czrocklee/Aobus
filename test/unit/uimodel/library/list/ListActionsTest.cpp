...
{
  TEST_CASE("ListActions - describes available actions from selected list state", "[uimodel][unit][list]")
  {
  ...
  TEST_CASE("ListActions - chooses a parent only for user-created list selections", "[uimodel][unit][list]")
  {
