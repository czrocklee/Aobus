...
namespace ao::uimodel::test
{
  ...
  TEST_CASE("AudioQualityFormatter - qualityForFinding", "[uimodel][unit][playback][quality]")
  {
  ...
  TEST_CASE("AudioQualityFormatter - playbackPath", "[uimodel][unit][playback][quality]")
  {
