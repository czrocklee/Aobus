...
namespace ao::uimodel::test
{
  ...
  TEST_CASE("OutputDeviceSelectionPolicy - validates intent against the output catalog",
  ...
  TEST_CASE("OutputDeviceSelectionPolicy - resolves preferred intent before session fallback",
            "[uimodel][unit][playback][output]")
  {
    auto const output = outputCatalog();
