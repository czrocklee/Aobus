...
namespace ao::uimodel::tag::test
{
  ...
  TEST_CASE("TrackPropertiesFormSpec projects editable metadata rows", "[uimodel][unit][tag][properties]")
  {
  ...
  TEST_CASE("TrackPropertiesFormSpec projects readonly technical property rows", "[uimodel][unit][tag][properties]")
  {
    auto const spec = buildTrackPropertiesFormSpec();
