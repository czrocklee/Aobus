...
{
  TEST_CASE("ListActionPolicy describes available actions from selected list state", "[unit][uimodel][list]")
  {
  ...
  TEST_CASE("ListActionPolicy chooses a parent only for user-created list selections", "[unit][uimodel][list]")
  {
