...
namespace ao::uimodel::track::test
{
  ...
  TEST_CASE("writeTrackFieldPatch writes editable metadata fields", "[uimodel][unit][track][edit]")
  {
  ...
  TEST_CASE("writeTrackFieldPatch rejects wrong edit value variants without mutation", "[uimodel][unit][track][edit]")
  {
