...
namespace ao::uimodel::track::test
{
  ...
  TEST_CASE("TrackFieldFormatter - duration formatting", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - uint16 formatting", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - filesize formatting", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - sample rate formatting", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - sample rate compact formatting", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - bitrate formatting", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - channels formatting", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - bit depth formatting", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - codec formatting", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - synthetic row text formatting", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("formatTrackFieldRawValue formats raw values by field policy", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("displayTextForTrackField resolves aggregate display text", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - text editing", "[uimodel][unit][track][formatter]")
  {
  ...
  TEST_CASE("TrackFieldFormatter - uint16 parsing", "[uimodel][unit][track][formatter]")
  {
