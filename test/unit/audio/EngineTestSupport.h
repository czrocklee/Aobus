...
namespace ao::audio::test
{
  ...
  {
    void enterAndWait();
    bool tryWaitForEntry(std::chrono::milliseconds timeout = std::chrono::seconds{10});
  ...
  public:
    ...
    bool tryWaitForRead(std::chrono::milliseconds timeout = std::chrono::seconds{10});
    void waitForRelease();
    void release();
  ...
  public:
    void notify();
    bool tryWaitForCount(std::size_t expected, std::chrono::milliseconds timeout = std::chrono::seconds{10});
