...
namespace ao::audio::test
{
  ...
  inline void checkClosedSession(DecoderSession& decoder)
  {
  ...
  inline std::uint64_t readUntilStableEndOfStream(DecoderSession& decoder, std::size_t maxBlocks)
  {
  ...
  inline TerminalReadResult readUntilTerminalState(DecoderSession& decoder, std::size_t maxBlocks)
  {
