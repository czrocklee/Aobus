...
namespace ao::audio::test
{
  ...
  public:
      ...
      : _mock(_base)
    {
      ...
      fakeit::Fake(Method(_mock, reset));
      ...
      fakeit::When(Method(_mock, getProperty))
        .AlwaysDo(
          [this](PropertyId id) -> ao::Result<PropertyValue>
          { return _base.getProperty(id); });

      fakeit::When(Method(_mock, queryProperty))
        .AlwaysDo(
          [this](PropertyId id) -> PropertyInfo
          { return _base.queryProperty(id); });
    }
