...
namespace ao::tag::mpeg::test
{
  ...
  TEST_CASE("MPEG Frame - Validation", "[tag][mpeg][frame]")
  {
  ...
  TEST_CASE("MPEG Frame - Properties", "[tag][mpeg][frame]")
  {
    SECTION("Layer I")
    {
  ...
  TEST_CASE("MPEG Frame - Xing Info", "[tag][mpeg][frame]")
  {
  ...
  TEST_CASE("MPEG Frame - Locate", "[tag][mpeg][frame]")
  {
    auto buffer =
