...
namespace ao::audio::detail
{
  ...
  // once at the subsystem's Result boundary, replacing repeated
  ...
  class DecoderException final : public std::exception
  {
  public:
  ...
  [[noreturn]] void throwDecoderError(Error::Code code,
                                      std::string message,
