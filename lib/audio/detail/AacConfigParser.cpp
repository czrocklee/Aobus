...
namespace ao::audio::detail
{
  namespace
  {
    ...
    constexpr auto kAacSampleRates = std::to_array<std::uint32_t>(
      {96000, 88200, 64000, 48000, 44100, 32000, 24000, 22050, 16000, 12000, 11025, 8000, 7350});
    constexpr auto kAacChannelCounts = std::to_array<std::uint8_t>({0, 1, 2, 3, 4, 5, 6, 8});
